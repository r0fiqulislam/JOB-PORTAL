 ...
 */
public class JobProviderRegister extends javax.swing.JFrame {

    /**
     * Creates new form JobProviderRegister
     */
    Connection conn;
    ResultSet rs;
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(535, 635));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            sql = "insert into JOBPROVIDER(C_USERNAME,COMPANY,EMAIL, PASS) values (?,?,?, ?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JobProviderRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
